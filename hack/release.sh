...
# make docker-build docker-push gh-extract IMG=robolaunchio/fleet-controller-manager:$1
make docker-buildx gh-extract IMG=robolaunchio/fleet-controller-manager:v$1
