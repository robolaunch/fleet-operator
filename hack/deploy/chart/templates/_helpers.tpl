...
helm.sh/chart: {{ include "fleet-operator.chart" . }}
{{ include "fleet-operator.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
app.kubernetes.io/name: {{ include "fleet-operator.name" . }}
